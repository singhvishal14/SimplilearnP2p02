...
using Assisgnment16.Data;
using Assisgnment16.Models;

namespace Assisgnment16.Controllers
{
    public class TasksController : Controller
    {
        private readonly TaskControllerContext _context;

        public TasksController(TaskControllerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Task != null ? 
                          ...
                          Problem("Entity set 'TaskControllerContext.Task'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TaskControllerContext.Task'  is null.");
            }
            var task = await _context.Task.FindAsync(id);
            if (task != null)
            {
